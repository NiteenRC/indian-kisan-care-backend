...
public class SalesOrderServiceTest {
	...
	public void saveOrderCase1Test() throws ParseException {
		...
		//Mockito.when(customerRepo.save(new Customer(customerName, order.getCustomer().getPhoneNumber()))).thenReturn(customer);
		...
		List<DailySummary> dailySummaries = Arrays.asList(dailySummary1);
